...
* Create a virtual environment and install Pytorch. Please choose the correct Pytorch version that matches your CUDA version from https://pytorch.org/get-started/previous-versions/
