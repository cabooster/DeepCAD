...
from data_process import train_preprocess_lessMemory, shuffle_datasets_lessMemory
...
def train(args):
    ...
    name_list, noise_img, coordinate_list = train_preprocess_lessMemory(args)
    ...
    optimizer = tf.train.AdamOptimizer(learning_rate=0.00005, beta1=0.5, beta2=0.999)
