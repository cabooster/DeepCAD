...
def test(args):
    ...
    with sess.as_default():
        ...
        for index in range(len(name_list)):
            ...
            aaaa = train_output[patch_start_s:patch_end_s, patch_start_h:patch_end_h, patch_start_w:patch_end_w]
            bbbb = train_input[patch_start_s:patch_end_s, patch_start_h:patch_end_h, patch_start_w:patch_end_w]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_s', type=int, default=464, help='the image number of patch stack')
    ...
    parser.add_argument('--gap_s', type=int, default=144, help='actions: train or predict')
    parser.add_argument('--normalize_factor', type=int, default=1, help='actions: train or predict')
    parser.add_argument('--datasets_folder', type=str, default='test2', help='actions: train or predict')
    parser.add_argument('--model_name', type=str, default='test2', help='actions: train or predict')
    ...
    parser.add_argument('--test_datasize', type=int, default=512, help='epoch for denoising')
