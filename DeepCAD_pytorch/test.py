...
parser.add_argument('--gap_h', type=int, default=48, help='the slices of image gap')
parser.add_argument('--gap_w', type=int, default=48, help='the width of image gap')
parser.add_argument('--gap_s', type=int, default=400, help='the height of image gap')
...
parser.add_argument('--datasets_folder', type=str, default='3_1.0zoom_depth70um_dendrite_0.3_low_MC', help="the name of your project")
parser.add_argument('--denoise_model', type=str, default='3_1.0zoom_depth70um_dendrite_0.3_low_MC_20201012-0703', help='epoch for denoising')
parser.add_argument('--test_datasize', type=int, default=800, help='epoch for denoising')
