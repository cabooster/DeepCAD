...
parser.add_argument('--gap_h', type=int, default=64, help='the slices of image gap')
parser.add_argument('--gap_w', type=int, default=64, help='the width of image gap')
parser.add_argument('--gap_s', type=int, default=64, help='the height of image gap')
...
parser.add_argument('--datasets_folder', type=str, default='4_1.0zoom_depth80um_dendrite_0.5_low', help="the name of your project")
